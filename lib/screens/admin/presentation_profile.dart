...
import 'package:ayesha_project/screens/admin/assets_tab.dart';
import 'package:ayesha_project/screens/admin/general_tab.dart';
...
class AdminPresenterProfileScreen extends StatefulWidget {
  final Session session;

  const AdminPresenterProfileScreen({super.key, required this.session});

  @override
  State<AdminPresenterProfileScreen> createState() =>
      _PresenterProfileScreenState();
}

class _PresenterProfileScreenState extends State<AdminPresenterProfileScreen> {
  @override
  void initState() {
    super.initState();
  }
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: TabBarView(
                    children: [
                      AdminGeneralTab(session: widget.session),
                      SessionTab(session: widget.session),
                      CommentsTab(sessionId: widget.session.id),
                      AdminAssetsTab(sessionId: widget.session.id)
                    ],
                  ),
                ),
              ],
